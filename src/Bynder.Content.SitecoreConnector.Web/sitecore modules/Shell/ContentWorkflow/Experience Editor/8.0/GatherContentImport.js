define(["sitecore"], function(sitecore) {
    sitecore.Commands.GCImportCommand =
    {
        ...
        execute: function(context) {
            ...
            var dialogPath = "/sitecore modules/shell/contentworkflow/import/import.html?id=" + itemId + "&l=" + context.currentContext.language + "&v=" + context.currentContext.version + "&db=" + context.currentContext.database;

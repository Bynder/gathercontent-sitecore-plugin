define(["sitecore",
  ...
  return function PageTestUtil(page) {
    ...
    var pageTestUtil = {
      ...
      validateSelectTest: function (callback) {
        ...
        if (itemId === infoItemId) {
          ...
          page.ItemInfoDataSource.set("isValidateTest", true);
          page.ItemInfoDataSource.set("itemUri", itemUri);
          //page.ItemInfoDataSource.set("itemId", itemId);
        }

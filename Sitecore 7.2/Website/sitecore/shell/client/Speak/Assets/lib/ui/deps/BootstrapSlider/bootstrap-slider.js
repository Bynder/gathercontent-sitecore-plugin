...
!function( $ ) {
	...
	var Slider = function(element, options) {
		...
		this.min = parseFloat(this.element.attr('data-slider-min'))||options.min;
		this.max = parseFloat(this.element.attr('data-slider-max')) || options.max;
		this.step = parseFloat(this.element.attr('data-slider-step')) || options.step;
		this.value = this.element.attr('data-slider-value').split(";");
		if (this.value[0] === "") {

  ...
  define(dependencies, function(sitecore, commonPagesDefinition) {
    ...
    return {
      ...
      importContacts: function() {
        ...
        $.post(actionUrl, mappingModel, function (data) { current.showSummary(data, timeout); }).error(function() { current.showErrorSummary(timeout); });
      },
      ...
      showErrorSummary: function(timeout) {
        ...
        commonPagesDefinition.showError(this.StringDictionary.get("The contacts have not been imported."), current.ImportWizardDialogMessageBar);

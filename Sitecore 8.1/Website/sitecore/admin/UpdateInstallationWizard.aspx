...
<body>
   <form id="form1" class="wf-container" runat="server" defaultbutton="btnNext">
      ...
      <div class="wf-footer">
         ...
         <asp:Button ID="btnNext" Text="Next >>" runat="server" OnClick="InstallationWizard_NextButtonClick" />
      </div>
   </form>
</body>
</html>

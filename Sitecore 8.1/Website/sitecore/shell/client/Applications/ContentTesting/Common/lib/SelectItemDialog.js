    ...
    SelectItemDialog: function (options) {
      ...
      var ob = {
        ...
        setSelectedItemFromTree: function () {
          ...
          this._hostPage.SelectItemItemInfoDataSource.set("itemId", null);
          this._hostPage.SelectItemItemInfoDataSource.set("itemUri", uri);
        ...
        setSelectedItemFromList: function () {
          ...
          this._hostPage.SelectItemItemInfoDataSource.set("itemUri", null);
          this._hostPage.SelectItemItemInfoDataSource.set("itemId", itemId);
          this.validateSelection();
        },

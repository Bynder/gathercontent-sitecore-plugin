...
namespace GatherContent.Connector.Website7.Commands
{
    public class ImportCommand : Command
    {
        ...
        protected void Run(ClientPipelineArgs args)
        {
            ...
            Context.ClientPage.ClientResponse.Broadcast(Context.ClientPage.ClientResponse.ShowModalDialog(path, "1200", "700", "Import Content from GatherContent", true), "Shell");
        }
    }
}
...
function ViewModel() {
    ...
    this.editMapping = function (item) {
        var id = item.CwbTemplateId;
        var scMappingId = item.ScMappingId;
        scForm.showModalDialog("/sitecore modules/shell/contentworkflow/Mappings/AddOrUpdateMapping.html?id=" + id + "&scMappingId=" + scMappingId,
            null, "center:yes;help:no;resizable:yes;scroll:yes;status:no;dialogMinHeight:600;dialogMinWidth:800;dialogWidth:800;dialogHeight:800;header: Manage Field Mappings");
    }
    this.editRelatedMapping = function (item) {
        var id = item.CwbTemplateId;
        var scMappingId = item.ScMappingId;
        scForm.showModalDialog("/sitecore modules/shell/contentworkflow/Mappings/AddOrUpdateRelatedMapping.html?id=" + id + "&scMappingId=" + scMappingId,
    ...
    this.addMoreTemplates = function () {
        scForm.showModalDialog("/sitecore modules/shell/contentworkflow/mappings/AddOrUpdateMapping.html",
            null, "center:yes;help:no;resizable:yes;scroll:yes;status:no;dialogMinHeight:600;dialogMinWidth:800;dialogWidth:800;dialogHeight:800;header: Manage Field Mappings");
    }
	
	this.addMoreRelatedTemplates = function () {
        scForm.showModalDialog("/sitecore modules/shell/contentworkflow/mappings/AddOrUpdateRelatedMapping.html",
            null, "center:yes;help:no;resizable:yes;scroll:yes;status:no;dialogMinHeight:600;dialogMinWidth:700;dialogWidth:700;dialogHeight:800;header: Manage Field Mappings");
    }
    ...
    var options =
        {
            ...
            showFilter: false,
            data: self.mappings,
            groups: ['MappingGroupId'],
            enablePaging: true,
            pagingOptions: self.pagingOptions,
            filterOptions: self.filterOptions,
            sortInfo: self.sortInfo,
            columnDefs: [
                { field: 'MappingGroupId', width: '**', displayName: 'Group Name', visible: false },
                { field: 'CwbProjectName', width: '**', displayName: 'Content Workflow Project' },
                { field: 'CwbTemplateName', width: '**', displayName: 'Content Workflow template' },
                ...
                { field: 'LastUpdatedDate', width: '**', displayName: 'Last updated in Content Workflow', sortFn: dateSort },
                { field: 'Manage', displayName: '&nbsp;', cellTemplate: '<a href="#" data-bind="click: function(){$parent.entity.IsRelated ? $parent.$userViewModel.editRelatedMapping($parent.entity) : $parent.$userViewModel.editMapping($parent.entity)}">Edit</a>', width: 50, resizable: false, sortable: false, cellClass: 'edit' },

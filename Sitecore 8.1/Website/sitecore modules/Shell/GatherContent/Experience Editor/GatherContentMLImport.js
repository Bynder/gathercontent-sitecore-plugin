define(["sitecore", "/-/speak/v1/ExperienceEditor/ExperienceEditor.js"], function (Sitecore, ExperienceEditor) {
    Sitecore.Commands.GCMLImportCommand =
  {
    ...
    execute: function (context) {
      ...
      var dialogPath = "/sitecore modules/shell/gathercontent/import/MultiLocationImport.html?id=" + itemId + "&l=" + context.currentContext.language + "&v=" + context.currentContext.version;

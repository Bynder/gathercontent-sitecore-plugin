  ...
  sitecore.Factories.createBaseComponent({
    ...
    addRows: function () {
      ...
      for (var i = 0; i < self.originalModel.length; i++) {
        ...
        var fieldModel = backbone.Model.extend({ defaults: { fieldName: "", dataField: "", required: false, position: "", autoMap: false } });

        var field = new fieldModel({ fieldName: fieldValue.FieldName, dataField: fieldValue.DataField, required: fieldValue.Required, position: i, autoMap: fieldValue.AutoMap });

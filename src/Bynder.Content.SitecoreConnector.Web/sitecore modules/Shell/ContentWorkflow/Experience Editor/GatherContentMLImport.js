define(["sitecore", "/-/speak/v1/ExperienceEditor/ExperienceEditor.js"], function(sitecore, experienceEditor) {
    sitecore.Commands.GCMLImportCommand =
    {
        ...
        execute: function(context) {
            ...
            var dialogPath = "/sitecore modules/shell/contentworkflow/import/MultiLocationImport.html?id=" + itemId + "&l=" + context.currentContext.language + "&v=" + context.currentContext.version + "&db=" + context.currentContext.database;
